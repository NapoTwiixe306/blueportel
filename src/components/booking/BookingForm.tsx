...
const T: Record<Locale, Record<string, string>> = {
  fr: {
    ...
    secure: "Paiement sécurisé Mollie (séjour réglé en totalité). Caution ménage de 100 € gérée par Swikly.",
  ...
  en: {
    ...
    secure: "Secure Mollie payment (stay paid in full). €100 cleaning deposit handled via Swikly.",
  ...
  nl: {
    ...
    secure: "Veilige Mollie-betaling (verblijf volledig betaald). Schoonmaakborg van € 100 geregeld via Swikly.",
