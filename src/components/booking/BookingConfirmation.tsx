...
const T: Record<Locale, Record<string, string>> = {
  fr: {
    ...
    paidText: "Votre acompte a bien été reçu. Un récapitulatif a été envoyé à",
    paidText2: "Le solde sera à régler 30 jours avant l'arrivée.",
  ...
  en: {
    ...
    paidText: "Your deposit was received. A summary has been sent to",
    paidText2: "The balance is due 30 days before arrival.",
  ...
  nl: {
    ...
    paidText: "Uw voorschot is ontvangen. Een overzicht is verstuurd naar",
    paidText2: "Het saldo is verschuldigd 30 dagen voor aankomst.",
