...
export const metadata: Metadata = {
  title: reserverCopy.nl.metaTitle,
  description: reserverCopy.nl.metaDescription,
  alternates: {
    canonical: "https://blueportel.fr/nl/pages/reserver",
    languages: {
